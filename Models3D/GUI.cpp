...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	WxSB_ScaleX->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );
	WxSB_ScaleX->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler(MyFrame1::ScrollX_Updated), NULL, this );

	WxSB_ScaleY->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );

	WxSB_ScaleZ->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
}
...
MyFrame1::~MyFrame1()
{
	...
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );
	WxSB_ScaleX->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MyFrame1::ScrollX_Updated ), NULL, this );

	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );
	WxSB_ScaleY->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MyFrame1::ScrollY_Updated ), NULL, this );

	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
	WxSB_ScaleZ->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MyFrame1::ScrollZ_Updated ), NULL, this );
