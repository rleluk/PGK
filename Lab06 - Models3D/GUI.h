...
class MyFrame1 : public wxFrame 
{
	...
	protected:
		...
		virtual void ScrollX_Updated(wxScrollEvent& event) { event.Skip(); }
		virtual void ScrollY_Updated(wxScrollEvent& event) { event.Skip(); }
		virtual void ScrollZ_Updated(wxScrollEvent& event) { event.Skip(); }
