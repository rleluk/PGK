...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	dodatkowe = new wxButton(this, wxID_ANY, _("Dodatkowe"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer2->Add(dodatkowe, 0, wxALIGN_CENTER | wxALL | wxEXPAND, 5);
	...
	// Connect Events
	dodatkowe->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::dodatkowe_click), NULL, this);
...
{
	// Disconnect Events
	dodatkowe->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::dodatkowe_click), NULL, this);
